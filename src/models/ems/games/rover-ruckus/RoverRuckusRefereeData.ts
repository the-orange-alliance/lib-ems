...
export default class RoverRuckusRefereeData implements IPostableObject {
  ...
  public toJSON(): object {
    return {
      ...
      blue_sample_one_silver_one_status: this.blueSampleOneSilverOneStatus,
      blue_sample_one_silver_two_status: this.blueSampleOneSilverTwoStatus,
      blue_sample_one_gold_status: this.blueSampleOneGoldStatus,
      blue_sample_two_silver_one_status: this.blueSampleTwoSilverOneStatus,
      blue_sample_two_silver_two_status: this.blueSampleTwoSilverTwoStatus,
      blue_sample_two_gold_status: this.blueSampleTwoGoldStatus
    };
  }
